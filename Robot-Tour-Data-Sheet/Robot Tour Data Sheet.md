...
| Positioned to the middle of the box before turning to move a bottle | ![image11](images/image11.png) | ![image12](images/image12.png) | until(17); right(); / left(); |
| Use l180 to move a bottle from an inaccessible area and positioning it back to move a bottle to the center of the grid | ![image13](images/image12.png) | ![image14](images/image13.png) | fw(50); l180(); / r180(); fw(50); |